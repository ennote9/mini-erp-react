...
**Preserved:** items, master data (suppliers, customers, warehouses, brands, categories, …), customer agreements, label templates, marking data, app settings, markdown master-data, and entity attachments for `customer` / `agreement`.
