  ...
  item: {
    ...
    prices: {
      ...
      replaceScheduledBody:
        "Уже запланирована будущая цена этого типа. Сохранение отменит предыдущую запись и создаст новую.",
      replaceScheduledConfirm: "Заменить",
      cancelConfirmTitle: "Отменить запланированную цену?",
      cancelConfirmBody: "Запись будет помечена как отменённая. Текущая активная цена не изменится.",
      ...
      reason_initial_migration: "Первичная миграция",
