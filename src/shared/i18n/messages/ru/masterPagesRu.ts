...
export const ruMasterPages: MessageTree = {
  ...
  item: {
    ...
    responsibles: {
      tabIntro:
        "Прямые назначения хранятся в карточке номенклатуры. Блоки по бренду и категории показывают сотрудников по зонам ответственности для контекста; они не перезаписывают сохранённые назначения автоматически.",
      unsavedHint:
        "Сначала сохраните карточку номенклатуры, затем можно будет назначать ответственных. Контекст по бренду/категории может отображаться, если в форме выбраны бренд и категория.",
      summaryDirect: "Прямые назначения",
      summaryBrand: "Связанные по бренду",
      summaryCategory: "Связанные по категории",
      summaryUnavailable: "Недоступные (прямые)",
      sectionDirect: "Прямые назначения",
      sectionBrand: "Связанные по бренду (только чтение)",
      sectionCategory: "Связанные по категории (только чтение)",
      colRole: "Роль",
      ...
      colActions: "Действия",
      colBusinessRoles: "Бизнес-роли",
      colScope: "Область",
      emptyRole: "Не назначено",
      relatedEmpty: "Нет связанных сотрудников для этой области.",
      noBrandOnItem: "Для позиции не выбран бренд.",
      noCategoryOnItem: "Для позиции не выбрана категория.",
      scopeBrandLine: "Бренд: {{name}}",
      scopeCategoryLine: "Категория: {{name}}",
      actionAssign: "Назначить",
      actionReplace: "Заменить",
      actionRemove: "Снять",
      actionQuickAssign: "Назначить на товар",
      dialogTitle: "Назначение ответственного",
      dialogHint: "Выберите сотрудника из справочника. На позицию — один сотрудник на роль.",
    ...
    prices: {
      tabIntro:
        "Здесь задаются базовая закупочная и базовая цена продажи. Не включает markdown-цены и индивидуальные цены по соглашениям с клиентами.",
      unsavedHint:
