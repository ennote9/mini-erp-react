...
export const kkMasterPages: MessageTree = {
  ...
  item: {
    ...
    responsibles: {
      tabIntro:
        "Тікелей тағайындаулар осы тауарда сақталады. Бренд пен санат блоктары контекст үшін аймақтар бойынша қызметкерлерді көрсетеді; сақталған тағайындауларды автоматты түрде өзгертпейді.",
      unsavedHint:
        "Алдымен номенклатура карточкасын сақтаңыз, содан кейін жауапты қызметкерлерді тағайындауға болады. Формада бренд пен санат таңдалған болса, контекст көрсетілуі мүмкін.",
      summaryDirect: "Тікелей тағайындаулар",
      summaryBrand: "Бренд бойынша байланысты",
      summaryCategory: "Санат бойынша байланысты",
      summaryUnavailable: "Қолжетімсіз (тікелей)",
      sectionDirect: "Тікелей тағайындаулар",
      sectionBrand: "Бренд бойынша байланысты (тек оқу)",
      sectionCategory: "Санат бойынша байланысты (тек оқу)",
      colRole: "Рөл",
      ...
      colBusinessRoles: "Бизнес рөлдері",
      colScope: "Аймақ",
      emptyRole: "Тағайындалмаған",
      relatedEmpty: "Осы аймақ үшін байланысты қызметкер жоқ.",
      noBrandOnItem: "Тауарда бренд таңдалмаған.",
      noCategoryOnItem: "Тауарда санат таңдалмаған.",
      scopeBrandLine: "Бренд: {{name}}",
      scopeCategoryLine: "Санат: {{name}}",
      actionAssign: "Тағайындау",
      actionReplace: "Ауыстыру",
      actionRemove: "Алып тастау",
      actionQuickAssign: "Тауарға тағайындау",
      dialogTitle: "Жауаптылықты тағайындау",
      dialogHint: "Анықтамадан қызметкерді таңдаңыз. Бір тауарда бір рөлге — бір қызметкер.",
