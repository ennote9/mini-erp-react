  ...
  item: {
    ...
    prices: {
      ...
      replaceScheduledBody:
        "Бұл түр үшін болашақ баға қойылған. Сақтау алдыңғы жоспарды болдырады және жаңасын жасайды.",
      replaceScheduledConfirm: "Ауыстыру",
      cancelConfirmTitle: "Жоспарланған бағаны болдырмау керек пе?",
      cancelConfirmBody: "Жазба болдырылған деп белгіленеді. Ағымдағы белсенді баға өзгермейді.",
      ...
      reason_initial_migration: "Бастапқы миграция",
