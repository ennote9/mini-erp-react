...
export const kkMasterPages: MessageTree = {
  ...
  item: {
    ...
    barcodes: {
      title: "Штрихкодтар",
      description: "Түрі мен қаптама деңгейі бойынша бірнеше штрихкод.",
      tabHint: "Штрихкодтарды түрі және қаптама деңгейі бойынша жүргізіңіз.",
