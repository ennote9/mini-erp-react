...
export const opsEn = {
  ...
  stock: {
    ...
    drilldown: {
      ...
      explainNonGoodStyle:
        "This style bucket is tracked separately. Planning demand and coverage are calculated only for good stock.",
      explainShort:
        "Available stock and expected supply do not cover demand. Uncovered shortage: {{shortage}} pcs.",
      explainAtRisk:
        "Demand is covered only with expected supply (available {{available}}, incoming {{incoming}}, demand {{outgoing}}).",
      explainCoveredWithDemand:
        "Current stock covers confirmed demand (available {{available}}, demand {{outgoing}}).",
      explainCoveredNoDemand: "There is no confirmed outgoing demand for this item right now.",
      summarySection: "Summary",
      kpiStripTitle: "Operational KPI summary",
      rightRailStatusTitle: "Coverage status",
      actionsTitle: "Actions",
      tabOperational: "Operational Summary",
      tabOutgoing: "Outbound Demand",
      tabIncoming: "Inbound Supply",
      tabReservations: "Active Reservations",
      explainabilityTitle: "Why the status looks like this",
      formulaBlockTitle: "Coverage formula",
      formulaAvailable: "Available",
      formulaProjected: "Projected stock",
      formulaNetShortage: "Net shortage",
      reservationsTitle: "Active reservations",
      reservationsEmpty: "No active reservations for this row.",
      reservationsEmptyLight: "No active reservations right now.",
      ...
      coverageImpact: "Coverage impact",
      recentMovementsTitle: "Recent stock movements",
      recentMovementsEmpty: "No stock movements found for this warehouse and item.",
  ...
  list: {
    ...
    barcodeRegistry: {
      emptyFiltered: "No codes match current search or filters",
      emptyDefault: "No barcode records yet",
      hintReadOnly: "This registry is read-only in phase 1. Create or edit codes in their native modules.",
      searchAria: "Search barcode registry by code",
      searchPlaceholder: "Search by code",
      entryTypeFilterAria: "Filter by barcode entry type",
      activeFilterAria: "Filter by active state",
      itemFilterAria: "Filter by item",
      sourceFilterAria: "Filter by source",
      filterAllEntryTypes: "All entry types",
      filterAllActiveStates: "All active states",
      filterActiveOnly: "Active only",
      filterInactiveOnly: "Inactive only",
      filterAllItems: "All items",
      filterAllSources: "All sources",
      entryTypeItemBarcode: "Item barcode",
      entryTypeMarkdownCode: "Markdown code",
      sourceMarkdownJournal: "Markdown journal",
    },
    brands: {
  ...
  stockBalances: {
    detail: {
      notFound: "Stock balance row not found.",
      backToListAria: "Back to stock balances",
    },
