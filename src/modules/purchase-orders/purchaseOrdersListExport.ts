...
function addSheet(workbook: Workbook, rows: PurchaseOrdersExportRow[], labels: ExcelListSheetLabels): void {
...
export async function buildPurchaseOrdersListXlsxBuffer(
  rows: PurchaseOrdersExportRow[],
