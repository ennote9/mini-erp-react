...
const COLUMN_HEADERS = ["№", "Number", "Date", "Customer", "Warehouse", "Status"] as const;
const SHEET_NAME = "Sales Orders";
const TABLE_NAME_BASE = "SalesOrdersTable";
...
function addSheet(workbook: Workbook, rows: SalesOrdersExportRow[]): void {
...
export async function buildSalesOrdersListXlsxBuffer(rows: SalesOrdersExportRow[]): Promise<ArrayBuffer> {
