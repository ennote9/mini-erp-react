...
function addSheet(workbook: Workbook, rows: SalesOrdersExportRow[], labels: ExcelListSheetLabels): void {
...
export async function buildSalesOrdersListXlsxBuffer(
  rows: SalesOrdersExportRow[],
