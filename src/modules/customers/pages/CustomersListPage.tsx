...
export function CustomersListPage() {
  ...
  const displayRowsWithQueryFilters = useMemo(
    () => applyListViewColumnFilters(listRows, columnFilterModel, customerColumnFilterConfigs),
    [listRows, columnFilterModel, customerColumnFilterConfigs],
  );

  const searchActive = searchQuery.trim() !== "";
  const filtersActive =
    preferredCarrierFilterId != null || hasActiveListViewColumnFilters(columnFilterModel);
  ...
  } = useListViewColumnSettings<CustomerListRow>({
    pageKey: "customers",
  ...
  const displayRowsWithDeepFilters = useMemo(
    () => applyListViewColumnFilters(displayRowsWithQueryFilters, deepFilterModel, customerColumnFilterConfigs),
  ...
  const listContent = (
    <>
      ...
      <ListViewColumnSettingsModal
        ...
        registry={columnSettingsRegistry}
        filterConfigs={customerColumnFilterConfigs as Record<string, ListViewColumnFilterConfig<unknown>>}
