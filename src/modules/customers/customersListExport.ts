...
function addSheet(workbook: Workbook, rows: CustomersExportRow[]): void {
...
export async function buildCustomersListXlsxBuffer(rows: CustomersExportRow[]): Promise<ArrayBuffer> {
