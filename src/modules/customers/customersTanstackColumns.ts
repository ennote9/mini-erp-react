...
type BuildCustomersTanstackColumnsInput = {
...
export function formatCustomersTableValue(input: {
...
function getColumnAlign(column: CustomersTableColumnSchema): ColumnMeta["align"] {
  if (column.id === "lineNo") return "right";
  if (column.rendererType === "numeric") return "right";
  return "left";
}

export function buildCustomersTanstackColumns(
  input: BuildCustomersTanstackColumnsInput,
): ColumnDef<CustomerListRow, any>[] {
