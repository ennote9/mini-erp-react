...
export function CategoriesListPage() {
  ...
  const displayRowsWithQueryFilters = useMemo(
    () => applyListViewColumnFilters(listRows, columnFilterModel, categoryColumnFilterConfigs),
  ...
  } = useListViewColumnSettings<CategoryListRow>({
    pageKey: "categories",
  ...
  const displayRowsWithDeepFilters = useMemo(
    () => applyListViewColumnFilters(displayRowsWithQueryFilters, deepFilterModel, categoryColumnFilterConfigs),
  ...
  const listContent = (
    <>
      ...
      <ListViewColumnSettingsModal
        ...
        registry={columnSettingsRegistry}
        filterConfigs={categoryColumnFilterConfigs as Record<string, ListViewColumnFilterConfig<unknown>>}
