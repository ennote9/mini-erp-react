...
export type WarehousesExportRow = {
  no: number;
  code: string;
  name: string;
  active: string;
...
const SHEET_NAME = "Warehouses";
const TABLE_NAME_BASE = "WarehousesTable";
...
function addSheet(workbook: Workbook, rows: WarehousesExportRow[]): void {
...
export async function buildWarehousesListXlsxBuffer(rows: WarehousesExportRow[]): Promise<ArrayBuffer> {
