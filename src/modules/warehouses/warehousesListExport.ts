...
function addSheet(workbook: Workbook, rows: WarehousesExportRow[], labels: ExcelListSheetLabels): void {
...
export async function buildWarehousesListXlsxBuffer(
  rows: WarehousesExportRow[],
