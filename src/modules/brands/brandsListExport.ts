...
const TABLE_NAME_BASE = "BrandsTable";
...
function addSheet(workbook: Workbook, rows: BrandsExportRow[], labels: ExcelListSheetLabels): void {
...
export async function buildBrandsListXlsxBuffer(
  rows: BrandsExportRow[],
